...
export const FruitCalculator = () => {
    ...
    const handleCropSelect = (item_id: string) => {
        ...
        const plantBaseValue: { [key: string]: number } = {
            ...
            'moonmelon': 7.6, 'durian': 7.6, 'peach': 1.9, 'cacao': 7.6, 'moonglow': 6.65,
            'dragonfruit': 11.38, 'mango': 14.28, 'moonblossom': 2.85, 'raspberry': 0.71, 'eggplant': 4.75,
            'papaya': 2.86, 'celestiberry': 1.9, 'moonmango': 14.25, 'passionfruit': 2.867,
            'soulfruit': 23.75, 'chocolatecarrot': 0.2616, 'redlolipop': 3.7988, 'candysunflower': 1.428,
            'lotus': 18.99, 'pineapple': 2.85, 'hive': 7.59, 'lilac': 2.846, 'rose': 0.95, 'foxglove': 1.9,
            'purpledahlia': 11.4, 'sunflower': 15.65, 'pinklily': 5.699, 'nectarine': 2.807, 'honeysuckle': 11.4,
            'lavender': 0.25, 'venusflytrap': 9.5, 'nectarshade': 0.75, 'manuka': 0.289, 'emberlily': 11.4,
            ...
            'kiwi': 4.75, 'greenapple': 2.85, 'banana': 1.42, 'pricklypear': 6.65, 'feijoa': 9.5, 'loquat': 6.17,
            'wildcarrot': 0.286, 'pear': 2.85, 'cantaloupe': 5.22, 'parasolflower': 5.7,
            'rosydelight': 9.5, 'elephantears': 17.1, 'bellpepper': 7.61,
            'aloevera': 5.22, 'peacelily': 0.5, 'travelersfruit': 11.4, 'delphinium': 0.285,
            'lilyofthevalley': 5.69, 'guanabana': 3.8, 'pitcherplant': 11.4, 'rafflesia': 7.6,
            'fireworkflower': 19, 'libertylily': 6.176, 'boneblossom': 2.85,
            'horneddinoshroom': 4.94, 'fireflyfern': 4.77, 'stonebite': 0.94,
            'boneboo': 14.5, 'paradisepetal': 2.85, 'burningbud': 11.4, 'fossilight': 3.79,
            'amberspine': 5.7, 'grandvolcania': 6.65, 'lingonberry': 0.485,
            'giantpinecone': 5.14, 'horsetail': 2.85, 'monoblooma': 0.477, 'spikedmango': 14.25,
            'taroflower': 6.64, 'serenity': 0.24, 'zenflare': 1.34, 'zenrocks': 17.1, 'hinomai': 9.5,
            'mapleapple': 2.85, 'softsunshine': 1.9, 'elderstrawberry': 5.37,
            'tranquilbloom': 3.79, 'luckybamboo': 4.75, 'dezen': 1.9, 'sakurabush': 1.42,
            'enkaku': 4.75, 'fruitball': 5.72
        };
